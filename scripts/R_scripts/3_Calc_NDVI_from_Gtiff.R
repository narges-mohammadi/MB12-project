...
setwd("C:/Users/sanaz/Desktop/Playground_dir_2")# "C:/Users/sanaz/Documents/MB12-project/Outputs/RGB_10m"
...
rgb_dir <- "C:/Users/sanaz/Desktop/Playground_dir_2/RGB"
ndvi_dir <- "C:/Users/sanaz/Desktop/Playground_dir_2/NDVI"
...
for(i in 1:num_loop){
  ...
  names(NDVI) <- paste0("NDVI_",unlist(strsplit(strsplit(S2_names_T[(i-1)*4+1],'/')[[1]][6],'[.]')[[1]][1]))
...
for(i in 1:num_loop_L2A){
  ...
  names(NDVI) <- paste0("NDVI_",unlist(strsplit(strsplit(S2_names_L2A_v1[(i-1)*4+1],'/')[[1]][6],'[.]')[[1]][1]))
...
saveRDS(select_10m, file = "C:/Users/sanaz/Desktop/Playground_dir_2/RGB/select10m.Rds")

#Load the select_10m.Rds ("select_10m" based on "RGB_10m")
select_10m <- readRDS(file = "C:/Users/sanaz/Documents/MB12-project/CREODIAS_part/data_from_CREODIAS/testdir/select10m_testdir.Rds") 
...
ggplot() +
  ...
  facet_wrap(~ variable)
ggsave("ggplot_ndvi_selected.png", scale = 3, dpi = 300)
...
ggsave("gghistogram_selected.png", scale = 3, dpi = 300)
...
avg_NDVI_stack$site <- "MFC2_GOR_Italy"
...
ggplot(avg_NDVI_stack, aes(sentinelDates, meanNDVI), na.rm=TRUE) +
  ...
  ggtitle("Sentinel Derived selected NDVI \n MFC2, GOR Field Sites") +
...
ggsave("ndvi_series_selected.png", scale = 3, dpi = 300)
