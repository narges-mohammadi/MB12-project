@ECHO OFF
REM // ***************************************************************************
REM // *  GDAL_Convert_All_JP2_2_tif.bat
REM // *  Recursively Scans directory for JP2 files and runs GDAL_JP2_2_tif on all
...
REM //
REM // 1^) Run GDAL_Convert_All_JP2_2_tif.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START GDAL_Convert_All_JP2_2_GeoTIFF.bat
ECHO #===========================================================================
...
IF /I "%1" EQU "" (
  ...
  ECHO   ERROR^: Missing the parameter for ^<Directory of JP2 Input Files^>^!
  ECHO.
  GOTO:BAT_DIRECTIONS
)
...
FOR /R %1 %%A IN (*.jp2) DO (
  ECHO CALL GDAL_JP2_2_GeoTIFF.bat %%A %%A.tif
  CALL GDAL_JP2_2_GeoTIFF.bat %%A %%A.tif
)
...
:End_BAT
ECHO #===========================================================================
ECHO END GDAL_Convert_All_JP2_2_GeoTIFF.bat
ECHO #===========================================================================
