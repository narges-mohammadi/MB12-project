@ECHO OFF
REM // ***************************************************************************
REM // *  GDAL_Convert_All_JP2_2_IMG.bat
REM // *  Recursively Scans directory for JP2 files and runs GDAL_JP2_2_IMG on all
REM // *  The IMG will be put in the same directory as the JP2 file
REM // *
...
REM //
REM // 1^) Run GDAL_Convert_All_JP2_2_IMG.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START GDAL_Convert_All_JP2_2_IMG.bat
ECHO #===========================================================================
...
FOR /R %1 %%A IN (*.jp2) DO (
  ECHO CALL GDAL_JP2_2_IMG.bat %%A %%A.img
  CALL GDAL_JP2_2_IMG.bat %%A %%A.img
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  GDAL_Convert_All_JP2_2_IMG ^<Dir of JP2 Files^>
...
:End_BAT
ECHO #===========================================================================
ECHO END GDAL_Convert_All_JP2_2_IMG.bat
ECHO #===========================================================================
