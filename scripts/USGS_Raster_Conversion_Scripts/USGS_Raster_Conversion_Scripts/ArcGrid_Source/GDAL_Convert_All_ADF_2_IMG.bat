@ECHO OFF
REM // ***************************************************************************
REM // *  GDAL_Convert_All_ADF_2_IMG.bat
REM // *  Recursively Scans directory for ADF files and runs GDAL_ADF_2_IMG on all
REM // *  The IMG will be put in the same directory as the ADF file
REM // *
...
REM //
REM // 1^) Run GDAL_Convert_All_ADF_2_IMG.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START GDAL_Convert_All_ADF_2_IMG.bat
ECHO #===========================================================================
...
FOR /R %1 %%A IN (*.adf) DO (
  IF NOT EXIST %%~dA%%~pAGDAL_ADF_2_IMG.img (
    REM This directory has not been processed, so create the output
	ECHO CALL GDAL_ADF_2_IMG.bat %%~dA%%~pA. %%~dA%%~pAGDAL_ADF_2_IMG.img
	CALL GDAL_ADF_2_IMG.bat %%~dA%%~pA. %%~dA%%~pAGDAL_ADF_2_IMG.img
  )
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  GDAL_Convert_All_ADF_2_IMG ^<Dir of ArcGrid Files^>
...
:End_BAT
ECHO #===========================================================================
ECHO END GDAL_Convert_All_ADF_2_IMG.bat
ECHO #===========================================================================
