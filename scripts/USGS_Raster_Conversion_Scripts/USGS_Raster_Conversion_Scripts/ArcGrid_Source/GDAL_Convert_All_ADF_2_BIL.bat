@ECHO OFF
REM // ***************************************************************************
REM // *  GDAL_Convert_All_ADF_2_BIL.bat
REM // *  Recursively Scans directory for ADF files and runs GDAL_ADF_2_BIL on all
...
REM //
REM // 1^) Run GDAL_Convert_All_ADF_2_BIL.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START GDAL_Convert_All_ADF_2_BIL.bat
ECHO #===========================================================================
...
FOR /R %1 %%A IN (*.adf) DO (
  IF NOT EXIST %%~dA%%~pAGDAL_ADF_2_BIL.bil (
    REM This directory has not been processed, so create the output
	ECHO CALL GDAL_ADF_2_BIL.bat %%~dA%%~pA. %%~dA%%~pAGDAL_ADF_2_BIL.bil
	CALL GDAL_ADF_2_BIL.bat %%~dA%%~pA. %%~dA%%~pAGDAL_ADF_2_BIL.bil
  )
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  GDAL_Convert_All_ADF_2_BIL ^<Dir of ArcGrid Files^>
...
:End_BAT
ECHO #===========================================================================
ECHO END GDAL_Convert_All_ADF_2_BIL.bat
ECHO #===========================================================================
