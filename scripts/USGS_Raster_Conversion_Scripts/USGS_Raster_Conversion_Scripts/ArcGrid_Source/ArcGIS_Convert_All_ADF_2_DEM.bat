@ECHO OFF
REM // ***************************************************************************
REM // *  ArcGIS_Convert_All_ADF_2_DEM.bat
...
REM //
REM // 1^) Run ArcGIS_Convert_All_ADF_2_DEM.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START ArcGIS_Convert_All_ADF_2_DEM.bat
ECHO #===========================================================================
...
FOR /R %1 %%A IN (*.adf) DO (
  IF NOT EXIST %%~dA%%~pA..\ArcGIS_ADF_2_ANY.dem (
    REM This directory has not been processed, so create the output
	ECHO CALL ArcGIS_ADF_2_ANY.bat %%~dA%%~pA. %%~dA%%~pA.\ArcGIS_ADF_2_ANY.dem
	CALL ArcGIS_ADF_2_ANY.bat %%~dA%%~pA. %%~dA%%~pA.\ArcGIS_ADF_2_ANY.dem
  )
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  ArcGIS_Convert_All_ADF_2_DEM ^<Dir of ArcGrid Files^>
...
:End_BAT
ECHO #===========================================================================
ECHO END ArcGIS_Convert_All_ADF_2_DEM.bat
ECHO #===========================================================================
