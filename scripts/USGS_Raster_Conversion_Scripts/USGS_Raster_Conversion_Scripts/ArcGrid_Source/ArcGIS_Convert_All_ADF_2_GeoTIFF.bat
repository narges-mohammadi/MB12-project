@ECHO OFF
REM // ***************************************************************************
REM // *  ArcGIS_Convert_All_ADF_2_GeoTIFF.bat
REM // *  Recursively Scans directory for ADF files and runs ArcGIS_ADF_2_ANY on all
REM // *  The TIF will be put in the same directory as the ADF file
REM // *
...
REM //
REM // 1^) Run ArcGIS_Convert_All_ADF_2_GeoTIFF.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START ArcGIS_Convert_All_ADF_2_GeoTIFF.bat
ECHO #===========================================================================
...
FOR /R %1 %%A IN (*.adf) DO (
  IF NOT EXIST %%~dA%%~pA..\ArcGIS_ADF_2_ANY.tif (
    REM This directory has not been processed, so create the output
	ECHO CALL ArcGIS_ADF_2_ANY.bat %%~dA%%~pA. %%~dA%%~pA.\ArcGIS_ADF_2_ANY.tif
	CALL ArcGIS_ADF_2_ANY.bat %%~dA%%~pA. %%~dA%%~pA.\ArcGIS_ADF_2_ANY.tif
  )
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  ArcGIS_Convert_All_ADF_2_GeoTIFF ^<Dir of ArcGrid Files^>
...
:End_BAT
ECHO #===========================================================================
ECHO END ArcGIS_Convert_All_ADF_2_GeoTIFF.bat
ECHO #===========================================================================
pause
