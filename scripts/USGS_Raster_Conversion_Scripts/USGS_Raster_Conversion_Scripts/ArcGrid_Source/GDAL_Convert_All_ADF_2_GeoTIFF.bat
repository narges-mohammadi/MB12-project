@ECHO OFF
REM // ***************************************************************************
REM // *  GDAL_Convert_All_ADF_2_GeoTIFF.bat
REM // *  Recursively Scans directory for ADF files and runs GDAL_ADF_2_GeoTIFF on all
REM // *  The GeoTIFF will be put in the same directory as the ADF file
REM // *
...
REM //
REM // 1^) Run GDAL_Convert_All_ADF_2_GeoTIFF.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START GDAL_Convert_All_ADF_2_GeoTIFF.bat
ECHO #===========================================================================
...
FOR /R %1 %%A IN (*.adf) DO (
  IF NOT EXIST %%~dA%%~pAGDAL_ADF_2_GeoTIFF.tif (
    REM This directory has not been processed, so create the output
	ECHO CALL GDAL_ADF_2_GeoTIFF.bat %%~dA%%~pA. %%~dA%%~pAGDAL_ADF_2_GeoTIFF.tif
	CALL GDAL_ADF_2_GeoTIFF.bat %%~dA%%~pA. %%~dA%%~pAGDAL_ADF_2_GeoTIFF.tif
  )
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  GDAL_Convert_All_ADF_2_GeoTIFF ^<Dir of ArcGrid Files^>
...
:End_BAT
ECHO #===========================================================================
ECHO END GDAL_Convert_All_ADF_2_GeoTIFF.bat
ECHO #===========================================================================
