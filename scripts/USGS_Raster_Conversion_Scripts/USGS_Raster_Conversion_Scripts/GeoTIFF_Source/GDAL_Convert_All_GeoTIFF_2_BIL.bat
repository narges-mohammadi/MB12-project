@ECHO OFF
REM // ***************************************************************************
REM // *  GDAL_Convert_All_GeoTIFF_2_BIL.bat
REM // *  Recursively Scans directory for GeoTIFF files and runs GDAL_GeoTIFF_2_BIL on all
...
REM //
REM // 1^) Run GDAL_Convert_All_GeoTIFF_2_BIL.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START GDAL_Convert_All_GeoTIFF_2_BIL.bat
ECHO #===========================================================================
...
IF /I "%1" EQU "" (
  ...
  ECHO   ERROR^: Missing the parameter for ^<Directory of GeoTIFF Input Files^>^!
  ECHO.
  GOTO:BAT_DIRECTIONS
)
...
FOR /R %1 %%A IN (*.tif) DO (
  ECHO CALL GDAL_GeoTIFF_2_BIL.bat %%A %%A.bil
  CALL GDAL_GeoTIFF_2_BIL.bat %%A %%A.bil
)
...
:End_BAT
ECHO #===========================================================================
ECHO END GDAL_Convert_All_GeoTIFF_2_BIL.bat
ECHO #===========================================================================
