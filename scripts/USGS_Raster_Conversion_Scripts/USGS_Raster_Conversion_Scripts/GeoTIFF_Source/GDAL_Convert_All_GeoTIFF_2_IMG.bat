@ECHO OFF
REM // ***************************************************************************
REM // *  GDAL_Convert_All_GeoTIFF_2_IMG.bat
REM // *  Recursively Scans directory for GeoTIFF files and runs GDAL_GeoTIFF_2_IMG on all
...
REM //
REM // 1^) Run GDAL_Convert_All_GeoTIFF_2_IMG.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START GDAL_Convert_All_GeoTIFF_2_IMG.bat
ECHO #===========================================================================
...
FOR /R %1 %%A IN (*.tif) DO (
  ECHO CALL GDAL_GeoTIFF_2_IMG.bat %%A %%A.img
  CALL GDAL_GeoTIFF_2_IMG.bat %%A %%A.img
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  GDAL_Convert_All_GeoTIFF_2_IMG ^<Dir of GeoTIFF Files^>
...
:End_BAT
ECHO #===========================================================================
ECHO END GDAL_Convert_All_GeoTIFF_2_IMG.bat
ECHO #===========================================================================
