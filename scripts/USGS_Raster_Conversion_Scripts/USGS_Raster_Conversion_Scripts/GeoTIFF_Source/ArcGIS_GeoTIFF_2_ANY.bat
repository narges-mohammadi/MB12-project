@ECHO OFF
REM // ***************************************************************************
REM // *  ArcGIS_GeoTIFF_2_ANY.bat
REM // *  Use ArcGIS Python to convert GeoTIFF Downloads to Format specified by extension
REM // *
...
REM //
REM // 1^) Run ArcGIS_GeoTIFF_2_ANY.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START ArcGIS_GeoTIFF_2_ANY.bat
ECHO #===========================================================================

REM initialize paramters to blanks
SET ArcGIS_GeoTIFF_2_ANY_SRC=
SET ArcGIS_GeoTIFF_2_ANY_OUTPUT=
...
IF /I "%1" EQU "" (
  ...
  IF NOT EXIST "%1" (
    ...
    REM Source exists so set the ArcGIS_GeoTIFF_2_ANY_SRC
	SET ArcGIS_GeoTIFF_2_ANY_SRC=%1
	
    REM Now check for the output location
    IF /I "%2" EQU "" (
	  REM The output location was not specified, so attempt to make local output directory and set ArcGIS_GeoTIFF_2_ANY_OUTPUT
	  IF NOT EXIST ANY_Output\NUL (
	    REM Output Directory does not exist, so create it.
		MKDIR ANY_Output
	  ) ELSE (
	    IF EXIST ANY_Output\ArcGIS_GeoTIFF_2_ANY.bil (
			ECHO   ERROR^: The specified [Output File Name] ^(ANY_Output\ArcGIS_GeoTIFF_2_ANY.bil^) already exists^!
			ECHO.
			GOTO:BAT_DIRECTIONS
		)
	  )
      SET ArcGIS_GeoTIFF_2_ANY_OUTPUT=ANY_Output\ArcGIS_GeoTIFF_2_ANY.bil
	) ELSE (
	  ...
	  IF EXIST "%2" (
	    ...
	    SET ArcGIS_GeoTIFF_2_ANY_OUTPUT=%2
	  )
	)
  )
)
...
IF EXIST "C:\Python27\ArcGIS10.3\python.exe" (
  ECHO "C:\Python27\ArcGIS10.3\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_GeoTIFF_2_ANY_SRC% %ArcGIS_GeoTIFF_2_ANY_OUTPUT%
  CALL "C:\Python27\ArcGIS10.3\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_GeoTIFF_2_ANY_SRC% %ArcGIS_GeoTIFF_2_ANY_OUTPUT%
) ELSE (
  IF EXIST "C:\Python27\ArcGIS10.2\python.exe" (
    ECHO "C:\Python27\ArcGIS10.2\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_GeoTIFF_2_ANY_SRC% %ArcGIS_GeoTIFF_2_ANY_OUTPUT%
    CALL "C:\Python27\ArcGIS10.2\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_GeoTIFF_2_ANY_SRC% %ArcGIS_GeoTIFF_2_ANY_OUTPUT%
  ) ELSE (
	IF EXIST "C:\Python27\ArcGIS10.1\python.exe" (
	  ECHO "C:\Python27\ArcGIS10.1\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_GeoTIFF_2_ANY_SRC% %ArcGIS_GeoTIFF_2_ANY_OUTPUT%
	  CALL "C:\Python27\ArcGIS10.1\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_GeoTIFF_2_ANY_SRC% %ArcGIS_GeoTIFF_2_ANY_OUTPUT%
	) ELSE (
	  IF EXIST "C:\Python26\ArcGIS10\python.exe" (
		ECHO "C:\Python26\ArcGIS10\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_GeoTIFF_2_ANY_SRC% %ArcGIS_GeoTIFF_2_ANY_OUTPUT%
		CALL "C:\Python26\ArcGIS10\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_GeoTIFF_2_ANY_SRC% %ArcGIS_GeoTIFF_2_ANY_OUTPUT%
	  ) ELSE (
		ECHO "python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_GeoTIFF_2_ANY_SRC% %ArcGIS_GeoTIFF_2_ANY_OUTPUT%
		CALL "python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_GeoTIFF_2_ANY_SRC% %ArcGIS_GeoTIFF_2_ANY_OUTPUT%
	  )
	)
  )
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  ArcGIS_GeoTIFF_2_^<GeoTIFF Input File^> [Output File Name]
ECHO       ^<GeoTIFF Input File^> = This is the relative or full path to the 
ECHO                                GeoTIFF file that contains the source 
ECHO                                data.
...
ECHO                            folder called ArcGIS_GeoTIFF_2_ANY.bil.  The 
...
:End_BAT
ECHO #===========================================================================
ECHO END ArcGIS_GeoTIFF_2_ANY.bat
ECHO #===========================================================================
