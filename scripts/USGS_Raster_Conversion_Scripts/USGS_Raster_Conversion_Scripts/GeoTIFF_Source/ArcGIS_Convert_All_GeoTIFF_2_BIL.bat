@ECHO OFF
REM // ***************************************************************************
REM // *  ArcGIS_Convert_All_GeoTIFF_2_BIL.bat
REM // *  Recursively Scans directory for GeoTIFF files and runs ArcGIS_GeoTIFF_2_ANY on all
REM // *  The BIL will be put in the same directory as the GeoTIFF file
REM // *
...
REM //
REM // 1^) Run ArcGIS_Convert_All_GeoTIFF_2_BIL.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START ArcGIS_Convert_All_GeoTIFF_2_BIL.bat
ECHO #===========================================================================
...
IF /I "%1" EQU "" (
  ...
  ECHO   ERROR^: Missing the parameter for ^<Dir of GeoTIFF Files^>^!
  ECHO.
  GOTO:BAT_DIRECTIONS
)
...
FOR /R %1 %%A IN (*.tif) DO (
  IF NOT EXIST %%~dA%%~pA..\ArcGIS_GeoTIFF_2_ANY.bil (
    REM This directory has not been processed, so create the output
	ECHO CALL ArcGIS_GeoTIFF_2_ANY.bat %%A %%~dA%%~pA.\ArcGIS_GeoTIFF_2_ANY.bil
	CALL ArcGIS_GeoTIFF_2_ANY.bat %%A %%~dA%%~pA.\ArcGIS_GeoTIFF_2_ANY.bil
  )
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  ArcGIS_Convert_All_GeoTIFF_2_BIL ^<Dir of GeoTIFF Files^>
ECHO       ^<Dir of GeoTIFF Files^> = This is the relative or full path to the 
ECHO                                directory of the GeoTIFF files that contain 
ECHO                                the GeoTIFF data.  It will scan
ECHO                                sub-folders recursively and produce BIL
ECHO                                files in the same folder as the GeoTIFF files.
pause

REM finish the script...
:End_BAT
ECHO #===========================================================================
ECHO END ArcGIS_Convert_All_GeoTIFF_2_BIL.bat
ECHO #===========================================================================
