@ECHO OFF
REM // ***************************************************************************
REM // *  ArcGIS_Convert_All_GeoTIFF_2_IMG.bat
...
REM //
REM // 1^) Run ArcGIS_Convert_All_GeoTIFF_2_IMG.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START ArcGIS_Convert_All_GeoTIFF_2_IMG.bat
ECHO #===========================================================================
...
FOR /R %1 %%A IN (*.tif) DO (
  IF NOT EXIST %%~dA%%~pA..\ArcGIS_GeoTIFF_2_ANY.img (
    REM This directory has not been processed, so create the output
	ECHO CALL ArcGIS_GeoTIFF_2_ANY.bat %%A %%~dA%%~pA.\ArcGIS_GeoTIFF_2_ANY.img
	CALL ArcGIS_GeoTIFF_2_ANY.bat %%A %%~dA%%~pA.\ArcGIS_GeoTIFF_2_ANY.img
  )
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  ArcGIS_Convert_All_GeoTIFF_2_IMG ^<Dir of GeoTIFF Files^>
...
:End_BAT
ECHO #===========================================================================
ECHO END ArcGIS_Convert_All_GeoTIFF_2_IMG.bat
ECHO #===========================================================================
