@ECHO OFF
REM // ***************************************************************************
REM // *  GDAL_Convert_All_FLT_2_GeoTIFF.bat
REM // *  Recursively Scans directory for FLT files and runs GDAL_FLT_2_GeoTIFF on all
REM // *  The GeoTIFF will be put in the same directory as the FLT file
REM // *
...
REM // OF MERCHANTAGeoTIFFITY, FITNESS FOR A PARTICULAR PURPOSE AND
REM // NONINFRINGEMENT. IN NO EVENT SHALL THE AUTHORS OR COPYRIGHT
REM // HOLDERS BE LIABLE FOR ANY CLAIM, DAMAGES OR OTHER LIAGeoTIFFITY,
...
REM //
REM // 1^) Run GDAL_Convert_All_FLT_2_GeoTIFF.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START GDAL_Convert_All_FLT_2_GeoTIFF.bat
ECHO #===========================================================================
...
FOR /R %1 %%A IN (*.flt) DO (
  ECHO CALL GDAL_FLT_2_GeoTIFF.bat %%A %%A.tif
  CALL GDAL_FLT_2_GeoTIFF.bat %%A %%A.tif
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  GDAL_Convert_All_FLT_2_GeoTIFF ^<Dir of GridFloat Files^>
...
:End_BAT
ECHO #===========================================================================
ECHO END GDAL_Convert_All_FLT_2_GeoTIFF.bat
ECHO #===========================================================================
