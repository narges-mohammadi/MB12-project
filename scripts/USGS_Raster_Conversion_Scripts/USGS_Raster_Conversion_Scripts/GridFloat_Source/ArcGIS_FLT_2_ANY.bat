@ECHO OFF
REM // ***************************************************************************
REM // *  ArcGIS_FLT_2_ANY.bat
REM // *  Use ArcGIS Python to convert GridFloat Downloads to Format specified by extension
REM // *
...
REM //
REM // 1^) Run ArcGIS_FLT_2_ANY.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START ArcGIS_FLT_2_ANY.bat
ECHO #===========================================================================

REM initialize paramters to blanks
SET ArcGIS_FLT_2_ANY_SRC=
SET ArcGIS_FLT_2_ANY_OUTPUT=
...
IF /I "%1" EQU "" (
  ...
  IF NOT EXIST "%1" (
    ...
    REM Source exists so set the ArcGIS_FLT_2_ANY_SRC
	SET ArcGIS_FLT_2_ANY_SRC=%1
	
    REM Now check for the output location
    IF /I "%2" EQU "" (
	  REM The output location was not specified, so attempt to make local output directory and set ArcGIS_FLT_2_ANY_OUTPUT
	  IF NOT EXIST ANY_Output\NUL (
	    REM Output Directory does not exist, so create it.
		MKDIR ANY_Output
	  ) ELSE (
	    IF EXIST ANY_Output\ArcGIS_FLT_2_ANY.bil (
			ECHO   ERROR^: The specified [Output File Name] ^(ANY_Output\ArcGIS_FLT_2_ANY.bil^) already exists^!
			ECHO.
			GOTO:BAT_DIRECTIONS
		)
	  )
      SET ArcGIS_FLT_2_ANY_OUTPUT=ANY_Output\ArcGIS_FLT_2_ANY.bil
	) ELSE (
...
IF EXIST "C:\Python27\ArcGIS10.3\python.exe" (
  ECHO "C:\Python27\ArcGIS10.3\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_FLT_2_ANY_SRC% %ArcGIS_FLT_2_ANY_OUTPUT%
  CALL "C:\Python27\ArcGIS10.3\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_FLT_2_ANY_SRC% %ArcGIS_FLT_2_ANY_OUTPUT%
) ELSE (
  IF EXIST "C:\Python27\ArcGIS10.2\python.exe" (
    ECHO "C:\Python27\ArcGIS10.2\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_FLT_2_ANY_SRC% %ArcGIS_FLT_2_ANY_OUTPUT%
    CALL "C:\Python27\ArcGIS10.2\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_FLT_2_ANY_SRC% %ArcGIS_FLT_2_ANY_OUTPUT%
  ) ELSE (
	IF EXIST "C:\Python27\ArcGIS10.1\python.exe" (
	  ECHO "C:\Python27\ArcGIS10.1\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_FLT_2_ANY_SRC% %ArcGIS_FLT_2_ANY_OUTPUT%
	  CALL "C:\Python27\ArcGIS10.1\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_FLT_2_ANY_SRC% %ArcGIS_FLT_2_ANY_OUTPUT%
	) ELSE (
	  IF EXIST "C:\Python26\ArcGIS10\python.exe" (
		ECHO "C:\Python26\ArcGIS10\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_FLT_2_ANY_SRC% %ArcGIS_FLT_2_ANY_OUTPUT%
		CALL "C:\Python26\ArcGIS10\python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_FLT_2_ANY_SRC% %ArcGIS_FLT_2_ANY_OUTPUT%
	  ) ELSE (
		ECHO "python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_FLT_2_ANY_SRC% %ArcGIS_FLT_2_ANY_OUTPUT%
		CALL "python.exe" ArcGIS_Python_RasterConvert.py %ArcGIS_FLT_2_ANY_SRC% %ArcGIS_FLT_2_ANY_OUTPUT%
	  )
	)
  )
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  ArcGIS_FLT_2_^<GridFloat Input File^> [Output File Name]
ECHO       ^<GridFloat Input File^> = This is the relative or full path to the 
ECHO                                GridFloat file that contains the GridFloat 
ECHO                                data.
...
ECHO                            folder called ArcGIS_FLT_2_ANY.bil.  The 
