@ECHO OFF
REM // ***************************************************************************
REM // *  GDAL_Convert_All_FLT_2_BIL.bat
REM // *  Recursively Scans directory for FLT files and runs GDAL_FLT_2_BIL on all
...
REM //
REM // 1^) Run GDAL_Convert_All_FLT_2_BIL.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START GDAL_Convert_All_FLT_2_BIL.bat
ECHO #===========================================================================
...
IF /I "%1" EQU "" (
  ...
  ECHO   ERROR^: Missing the parameter for ^<Directory of GridFloat Input Files^>^!
  ECHO.
  GOTO:BAT_DIRECTIONS
)
...
FOR /R %1 %%A IN (*.flt) DO (
  ECHO CALL GDAL_FLT_2_BIL.bat %%A %%A.bil
  CALL GDAL_FLT_2_BIL.bat %%A %%A.bil
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  GDAL_Convert_All_FLT_2_BIL ^<Dir of GridFloat Files^>
...
:End_BAT
ECHO #===========================================================================
ECHO END GDAL_Convert_All_FLT_2_BIL.bat
ECHO #===========================================================================
