@ECHO OFF
REM // ***************************************************************************
REM // *  ArcGIS_Convert_All_FLT_2_BIL.bat
REM // *  Recursively Scans directory for FLT files and runs ArcGIS_FLT_2_ANY on all
REM // *  The BIL will be put in the same directory as the FLT file
REM // *
...
REM //
REM // 1^) Run ArcGIS_Convert_All_FLT_2_BIL.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START ArcGIS_Convert_All_FLT_2_BIL.bat
ECHO #===========================================================================
...
FOR /R %1 %%A IN (*.flt) DO (
  IF NOT EXIST %%~dA%%~pAArcGIS_FLT_2_ANY.bil (
    REM This directory has not been processed, so create the output
	ECHO CALL ArcGIS_FLT_2_ANY.bat %%~dA%%~pA. %%~dA%%~pAArcGIS_FLT_2_ANY.bil
	CALL ArcGIS_FLT_2_ANY.bat %%~dA%%~pA. %%~dA%%~pAArcGIS_FLT_2_ANY.bil
  )
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  ArcGIS_Convert_All_FLT_2_BIL ^<Dir of GridFloat Files^>
...
:End_BAT
ECHO #===========================================================================
ECHO END ArcGIS_Convert_All_FLT_2_BIL.bat
ECHO #===========================================================================
