@ECHO OFF
REM // ***************************************************************************
REM // *  GDAL_Convert_All_FLT_2_IMG.bat
REM // *  Recursively Scans directory for FLT files and runs GDAL_FLT_2_IMG on all
...
REM // OF MERCHANTAIMGITY, FITNESS FOR A PARTICULAR PURPOSE AND
REM // NONINFRINGEMENT. IN NO EVENT SHALL THE AUTHORS OR COPYRIGHT
REM // HOLDERS BE LIABLE FOR ANY CLAIM, DAMAGES OR OTHER LIAIMGITY,
...
REM //
REM // 1^) Run GDAL_Convert_All_FLT_2_IMG.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START GDAL_Convert_All_FLT_2_IMG.bat
ECHO #===========================================================================
...
FOR /R %1 %%A IN (*.flt) DO (
  ECHO CALL GDAL_FLT_2_IMG.bat %%A %%A.img
  CALL GDAL_FLT_2_IMG.bat %%A %%A.img
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  GDAL_Convert_All_FLT_2_IMG ^<Dir of GridFloat Files^>
ECHO       ^<Dir of GridFloat Files^> = This is the relative or full path to the 
ECHO                                  directory of the flt files that contain 
...
:End_BAT
ECHO #===========================================================================
ECHO END GDAL_Convert_All_FLT_2_IMG.bat
ECHO #===========================================================================
