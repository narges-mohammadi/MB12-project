@ECHO OFF
REM // ***************************************************************************
REM // *  ArcGIS_Convert_All_IMG_2_BIL.bat
REM // *  Recursively Scans directory for IMG files and runs ArcGIS_IMG_2_ANY on all
REM // *  The BIL will be put in the same directory as the IMG file
REM // *
...
REM //
REM // 1^) Run ArcGIS_Convert_All_IMG_2_BIL.bat to obtain USAGE directions
REM //
REM //*****************************************************************************

ECHO #===========================================================================
ECHO START ArcGIS_Convert_All_IMG_2_BIL.bat
ECHO #===========================================================================
...
REM recursively search for all IMG files in the input directory
FOR /R %1 %%A IN (*.img) DO (
  IF NOT EXIST %%~dA%%~pA..\ArcGIS_IMG_2_ANY.bil (
    REM This directory has not been processed, so create the output
	ECHO CALL ArcGIS_IMG_2_ANY.bat %%A %%~dA%%~pA.\ArcGIS_IMG_2_ANY.bil
	CALL ArcGIS_IMG_2_ANY.bat %%A %%~dA%%~pA.\ArcGIS_IMG_2_ANY.bil
  )
)
...
:BAT_DIRECTIONS
ECHO   USAGE^:  ArcGIS_Convert_All_IMG_2_BIL ^<Dir of IMG Files^>
...
:End_BAT
ECHO #===========================================================================
ECHO END ArcGIS_Convert_All_IMG_2_BIL.bat
ECHO #===========================================================================
